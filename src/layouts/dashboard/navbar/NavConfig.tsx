...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      // USER
      {
        title: 'Martin - Activity 23',
        path: PATH_DASHBOARD.rep.view('martin'),
        icon: ICONS.user,
        // children: [
      ...
      // E-COMMERCE
      {
        title: 'Bhavuk - Activity 27',
        path: PATH_DASHBOARD.rep.view('bhavuk'),
        icon: ICONS.user,
        // children: [
      ...
      // INVOICE
      {
        title: 'Teddy - Activity 25',
        path: PATH_DASHBOARD.rep.view('teddy'),
        icon: ICONS.user,
        // children: [
      ...
      // BLOG
      {
        title: 'Xav - Activity 24',
        path: PATH_DASHBOARD.rep.view('xav'),
        icon: ICONS.user,
        // children: [
